...
class Model:
    ...
    def get_equations(self):
        ...
        """
            状态变量x: [m, rI, vI, qI2B, ωI]  (变质量, 质心位置, 质心速度, 四元数朝向, 旋转角速度)
            控制变量u: [TI]  (推进力矢量)
        """
    ...
    def get_constraints(self, X_v, U_v, X_last_p, U_last_p):
        ...
        # these constraints are all convex ones
        constraints += [
            # State constraints:
            ...
            # cvx.norm(U_v, axis=0) >= self.T_min  # simple lower thrust constraint
